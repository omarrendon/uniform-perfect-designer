...
export const ExportLoadingOverlay: React.FC<ExportLoadingOverlayProps> = ({
  isVisible,
  currentPage,
  totalPages,
}) => {
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '24px' }}>
          <div style={{ position: 'relative', marginBottom: '16px' }}>
            ...
            />
            {/* Icono de documento en el centro */}
            <div style={{
              position: 'absolute',
              top: 0,
              left: 0,
              ...
              <FileDown style={{ width: '32px', height: '32px', color: '#2563eb' }} />
            </div>
          </div>
          ...
          <p style={{
            ...
            Por favor espera mientras generamos tus archivos...
          </p>
        </div>
